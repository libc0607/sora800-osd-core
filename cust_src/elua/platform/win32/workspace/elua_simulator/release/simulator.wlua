...
dlg = iup.dialog
{
	...
	;title = "Luat模拟器V1.0.0",size = "200x", margin = "10x10", resize = "NO", maxbox = "NO", minbox = "NO"
}
...
local function getcoms()
	local h = luawinio.popen([[reg query "HKEY_LOCAL_MACHINE\Hardware\DeviceMap\SerialComm"]])
	coms = {"NONE"}
