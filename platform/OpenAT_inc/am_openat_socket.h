...
#define EBADF         9  /* Invalid socket descriptor                  */
#define EFAULT       14  /* Bad address specified                      */
#define EINVAL       22  /* Invalid operation                          */
#define EMFILE       24  /* No free socket descriptors                 */
#define EWOULDBLOCK  35  /* The operation would block                  */
#define EALREADY     37  /* A previous attempt at this operation is    */
                             /* still ongoing                              */
#define EDESTADDRREQ 39  /* Socket is not bound                        */
#define EMSGSIZE     40  /* The supplied buffer was too large / small  */
#define ENOTSUPP     43  /* Flags not supported                        */
#define EOPNOTSUPP   45  /* Operation not supported                    */
#define EADDRINUSE   48  /* The address is already in use              */
#define ENETDOWN     50  /* The network is unavailable                 */
#define ECONNABORTED 53  /* An established connection was aborted,     */
                              /* possibly due to a data transmission        */
                              /* time-out or protocol error                 */
#define ECONNRESET   54  /* Remote host has reset the  connection.     */
#define ENOBUFS      55  /* No buffer space available                  */
#define EISCONN      56  /* The socket is already connected            */
#define ENOTCONN     57  /* The socket is not connected                */
#define ESHUTDOWN    58  /* Socket has been shutdown                   */
#define ETIMEDOUT    60  /* Connection timed out                       */
#define ECONNREFUSED 61  /* Remote host has rejected the connection.   */
#define EHOSTUNREACH 65  /* Remote host is unreachable                 */
#define EUNEXPECTED  99  /* An unexpected error occurred               */

/* DNS errors */
#define  EHOST_NOT_FOUND  1001 /* Host not found                        */
#define  ETRY_AGAIN       1002 /* An error occurred that may be         */
                                   /* transient; a further attempt may      */
                                   /* succeed.                              */
#define  ENO_RECOVERY     1003 /* An unrecoverable error occurred       */
...
/**@brief sockaddr_in, sockaddr_in */
struct sockaddr_in {
  //uint8 sin_len;
  uint16 sin_family; /**< 网络协议 AF_INET */
  uint16 sin_port;   /**< 端口 */
  struct in_address sin_addr; /**< ip地址 */
  char sin_zero[8];  /**< 一般为空 */
};
