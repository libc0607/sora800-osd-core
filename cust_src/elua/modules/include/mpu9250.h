...
// gyro data
typedef struct mpu9250_gyrof_s
{
	float x;
	float y;
	float z;
...
// accel data
typedef struct mpu9250_accelf_s
{
	float x;
	float y;
	float z;
...
// quaternion
// q = a + xi + yj + zk
typedef struct mpu9250_quaternionf_s
{
	float a;
	float x;
	float y;
	float z;
} mpu9250_quaternionf_t;

// dmp raw data
typedef struct mpu9250_dmpraw_s
{
